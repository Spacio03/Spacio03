...
Focus: NLP, retrieval systems, and scalable data pipelines  
...
- Designing end-to-end ML pipelines (data → model → API → evaluation)
...
### Zero-Shot Feedback Intelligence
...
FAISS • XGBoost • LangChain  
Airflow • Snowflake • AWS • Docker  
